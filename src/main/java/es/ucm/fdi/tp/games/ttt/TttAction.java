...
public class TttAction implements GameAction<TttState, TttAction> {
	...
	public boolean equals(Object arg0) {
    	boolean r = false;
		if(arg0 instanceof TttAction) {
			TttAction tttToCompare = (TttAction) arg0;
			boolean rowsEquals = this.row == tttToCompare.row;
			boolean colsEquals = this.col == tttToCompare.col;
			r = rowsEquals && colsEquals;
		}
