...
import static es.ucm.fdi.tp.games.chess.ChessBoard.DIM;
import static es.ucm.fdi.tp.games.chess.ChessBoard.empty;
import static es.ucm.fdi.tp.games.chess.ChessBoard.enemy;
import static es.ucm.fdi.tp.games.chess.ChessBoard.sameTurn;
...
import es.ucm.fdi.tp.games.chess.ChessAction.Special;
...
public class ChessState extends GameState<ChessState, ChessAction> {
     ...
     */
    public static boolean threatenedBy(ChessBoard b, int turn, int row, int col) {
        for (int i = 0; i < DIM; i++) {
            for (int j = 0; j < DIM; j++) {
                byte p = b.get(i, j);
