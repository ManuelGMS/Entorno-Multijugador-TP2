...
import es.ucm.fdi.tp.games.chess.ChessBoard;
import es.ucm.fdi.tp.games.chess.ChessState;

import static es.ucm.fdi.tp.games.chess.ChessState.BLACK;
import static es.ucm.fdi.tp.games.chess.ChessState.WHITE;
import static es.ucm.fdi.tp.games.chess.ChessState.threatenedBy;
